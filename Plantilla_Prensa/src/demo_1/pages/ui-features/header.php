            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/buttons.html">Juegos</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/roster/index.php">Roster</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/typography.html">Duelo de abridores</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/generar.html">Generar</a>
                  </li>
                </ul>
              </div>
            </li>
