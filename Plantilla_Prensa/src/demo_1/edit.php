			...
			<div class="panel">
                ...
                <br>
                    ...
                    return false;        
                        ...
                        <?php
                          if($array[2]==1 or $array[3]==1){
                        ?>
                                
                <label for="titulo"  style="margin-left: 15px; width: 250px;  position: absolute">Asistencia: </label>
            <input class="form-control" name="asistencia" id="asistencia" onkeypress="return validaNumericos(event)" style="margin-left: 100px; position: absolute; width: 250px" type="text" placeholder="Asistencia">
               <br>                 
                <br>
             <label for="titulo"  style="margin-left: 15px; width: 250px;  position: absolute">Duración: </label>
            <input class="form-control" name="tiempo" id="tiempo" style="margin-left: 100px; position: absolute; width: 250px" type="text">
                <br>
                <br>
              <?php 
              }?>
